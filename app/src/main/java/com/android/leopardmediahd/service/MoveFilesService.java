...
public class MoveFilesService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		File oldDataFolder = com.android.leopardmediahd.utils.FileUtils.getOldDataFolder();
		...
		File oldMovieThumbs = new File(com.android.leopardmediahd.utils.FileUtils.getOldDataFolder() + "/movie-thumbs");
		...
		File oldTvShowThumbs = new File(com.android.leopardmediahd.utils.FileUtils.getOldDataFolder() + "/tvshows-thumbs");
		...
		com.android.leopardmediahd.utils.FileUtils.deleteRecursive(oldDataFolder, true);

		Intent i = new Intent(this, com.android.leopardmediahd.leopardmediahd.SplashScreen.class);
	...
	private void movieBackdrop(File backdrop) {
		try {
			com.android.leopardmediahd.utils.FileUtils.copyFile(backdrop, new File(com.android.leopardmediahd.leopardmediahd.MizuuApplication.getMovieBackdropFolder(this), backdrop.getName()));
		} catch (IOException e) {}
	}

	private void tvShowBackdrop(File backdrop) {
		try {
			com.android.leopardmediahd.utils.FileUtils.copyFile(backdrop, new File(com.android.leopardmediahd.leopardmediahd.MizuuApplication.getTvShowBackdropFolder(this), backdrop.getName()));
		} catch (IOException e) {}
	}

	private void episodePhoto(File episode) {
		try {
			com.android.leopardmediahd.utils.FileUtils.copyFile(episode, new File(com.android.leopardmediahd.leopardmediahd.MizuuApplication.getTvShowEpisodeFolder(this), episode.getName()));
		} catch (IOException e) {}
	}

	private void movieThumb(File thumb) {
		try {
			com.android.leopardmediahd.utils.FileUtils.copyFile(thumb, new File(com.android.leopardmediahd.leopardmediahd.MizuuApplication.getMovieThumbFolder(this), thumb.getName()));
		} catch (IOException e) {}
	}

	private void tvShowThumb(File thumb) {
		try {
			com.android.leopardmediahd.utils.FileUtils.copyFile(thumb, new File(com.android.leopardmediahd.leopardmediahd.MizuuApplication.getTvShowThumbFolder(this), thumb.getName()));
		} catch (IOException e) {}
	}
}