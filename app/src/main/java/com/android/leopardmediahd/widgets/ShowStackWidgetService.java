...
import com.android.leopardmediahd.widgets.ShowStackWidgetProvider;
...
public class ShowStackWidgetService extends RemoteViewsService {
	...
	public RemoteViewsFactory onGetViewFactory(Intent intent) {
		return new com.android.leopardmediahd.widgets.StackRemoteViewsFactoryTv(this.getApplicationContext(), intent);
	}
}
