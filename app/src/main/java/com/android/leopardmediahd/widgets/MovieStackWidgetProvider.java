...
import com.android.leopardmediahd.widgets.MovieStackWidgetService;
...
public class MovieStackWidgetProvider extends AppWidgetProvider {
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
		...
		for (int i = 0; i < appWidgetIds.length; ++i) {
			...
			Intent toastIntent = new Intent(context, com.android.leopardmediahd.widgets.MovieStackWidgetProvider.class);
