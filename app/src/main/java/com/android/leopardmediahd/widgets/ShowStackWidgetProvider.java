...
public class ShowStackWidgetProvider extends AppWidgetProvider {
	...
	public void onReceive(Context context, Intent intent) {  
		...
		if (SHOW_STACK_WIDGET.equals(action)) {
			...
			openShow.setClass(context, com.android.leopardmediahd.leopardmediahd.TvShowDetails.class);
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
		...
		for (int i = 0; i < appWidgetIds.length; ++i) {
			...
			Intent intent = new Intent(context, com.android.leopardmediahd.widgets.ShowStackWidgetService.class);
