...
import com.android.leopardmediahd.functions.SmallMovie;
import com.android.leopardmediahd.leopardmediahd.MizuuApplication;
import com.android.leopardmediahd.R;
import com.android.leopardmediahd.widgets.*;
import com.android.leopardmediahd.widgets.MovieBackdropWidgetProvider;
...
public class MovieBackdropWidgetService extends RemoteViewsService {
	...
	static class BookmarkFactory implements RemoteViewsFactory {
		...
		public BookmarkFactory(Context context, int widgetId) {
			...
			mLoadingView = new RemoteViews(mContext.getPackageName(), R.layout.movie_backdrop_widget_item);
		}
		...
		public RemoteViews getViewAt(int position) {
			...
			try {
				Bitmap cover = mPicasso.load(movies.get(position).getBackdrop()).config(mConfig).get();
