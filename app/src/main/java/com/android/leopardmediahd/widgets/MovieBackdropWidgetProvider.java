...
import com.android.leopardmediahd.widgets.MovieBackdropWidgetService;
...
public class MovieBackdropWidgetProvider extends AppWidgetProvider {
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
		for (int i = 0; i < appWidgetIds.length; ++i) {
			...
			Intent toastIntent = new Intent(context, com.android.leopardmediahd.widgets.MovieBackdropWidgetProvider.class);
