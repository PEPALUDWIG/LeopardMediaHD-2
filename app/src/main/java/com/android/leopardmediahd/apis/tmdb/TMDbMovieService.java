...
import com.android.leopardmediahd.abstractclasses.MovieApiService;
...
import com.android.leopardmediahd.functions.CompleteActor;
...
import static com.android.leopardmediahd.functions.PreferenceKeys.MOVIE_RATINGS_SOURCE;

public class TMDbMovieService extends MovieApiService {

	private static com.android.leopardmediahd.apis.tmdb.TMDbMovieService mService;

	private final String mTmdbApiKey;
	private final Context mContext;

	public static com.android.leopardmediahd.apis.tmdb.TMDbMovieService getInstance(Context context) {
		if (mService == null)
			mService = new com.android.leopardmediahd.apis.tmdb.TMDbMovieService(context);
		return mService;
	}
	...
	public Movie get(String id, String json, String language) {
		...
		try {
			...
			if (getRatingsProvider().equals(mContext.getString(R.string.ratings_option_2)) && json == null) {
				try {
					com.android.leopardmediahd.apis.trakt.Movie movieSummary = Trakt.getMovieSummary(mContext, id);
