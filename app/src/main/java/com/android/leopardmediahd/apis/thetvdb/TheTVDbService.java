...
package com.android.leopardmediahd.apis.thetvdb;
...
import com.android.leopardmediahd.apis.thetvdb.*;
...
import static com.android.leopardmediahd.functions.PreferenceKeys.DVD_ORDERING;
...
public class TheTVDbService extends TvShowApiService {
	...
	private static com.android.leopardmediahd.apis.thetvdb.TheTVDbService mService;

	private final String mTvdbApiKey;
	private final Context mContext;

	public static com.android.leopardmediahd.apis.thetvdb.TheTVDbService getInstance(Context context) {
		if (mService == null)
			mService = new com.android.leopardmediahd.apis.thetvdb.TheTVDbService(context);
		return mService;
	}
		...
		try {
			...
			for (int i = 0; i < nodeList.getLength(); i++) {
				...
				if (firstNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					com.android.leopardmediahd.apis.thetvdb.Episode episode = new Episode();
