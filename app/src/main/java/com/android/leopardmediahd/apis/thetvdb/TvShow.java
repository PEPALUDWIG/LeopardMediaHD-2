...
public class TvShow {
	...
	private String mShowId = DbAdapterTvShows.UNIDENTIFIED_ID,
			...
			mFirstAired = "",
			mImdbId = "";
	private ArrayList<com.android.leopardmediahd.apis.thetvdb.Episode> mEpisodes = new ArrayList<com.android.leopardmediahd.apis.thetvdb.Episode>();
	...
	public void addEpisode(com.android.leopardmediahd.apis.thetvdb.Episode ep) {
		mEpisodes.add(ep);
	}
