...
package com.android.leopardmediahd.apis.trakt;
...
import com.android.leopardmediahd.apis.trakt.Show;
import com.android.leopardmediahd.apis.trakt.TraktTvShow;
import com.android.leopardmediahd.functions.MediumMovie;
import com.android.leopardmediahd.functions.MizLib;
import com.android.leopardmediahd.functions.Movie;
...
import static com.android.leopardmediahd.functions.PreferenceKeys.TRAKT_PASSWORD;
...
public class Trakt {
	...
	public static boolean markEpisodeAsWatched(String showId, List<com.android.leopardmediahd.functions.TvShowEpisode> episodes, Context c, boolean watched) {
		SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(c);
		String username = settings.getString(TRAKT_USERNAME, "").trim();
		String password = settings.getString(TRAKT_PASSWORD, "");
	...
	public static com.android.leopardmediahd.apis.trakt.Movie getMovieSummary(Context context, String movieId) {
		return new com.android.leopardmediahd.apis.trakt.Movie(MizLib.getJSONObject(context, "http://api.trakt.tv/movie/summary.json/" + getApiKey(context) + "/" + movieId));
	}
}