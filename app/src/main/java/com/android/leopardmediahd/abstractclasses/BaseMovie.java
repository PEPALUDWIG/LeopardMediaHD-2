...
public abstract class BaseMovie implements Comparable<com.android.leopardmediahd.abstractclasses.BaseMovie> {
	...
	@Override
	public int compareTo(com.android.leopardmediahd.abstractclasses.BaseMovie another) {
