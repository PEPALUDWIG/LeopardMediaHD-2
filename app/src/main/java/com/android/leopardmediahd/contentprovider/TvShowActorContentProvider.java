...
public class TvShowActorContentProvider extends SearchRecentSuggestionsProvider {
	...
	static final String TAG = com.android.leopardmediahd.contentprovider.TvShowActorContentProvider.class.getSimpleName();
	public static final String AUTHORITY = com.android.leopardmediahd.contentprovider.TvShowActorContentProvider.class.getName();
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				cursor.addRow(createRow(i, list.get(i), mActor, ContentResolver.SCHEME_ANDROID_RESOURCE + "://com.android.leopardmediahd/drawable/ic_person_white_24dp", list.get(i)));
			}
		} catch (Exception e) {
