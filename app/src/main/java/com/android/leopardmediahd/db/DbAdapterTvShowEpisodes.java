...
import com.android.leopardmediahd.db.AbstractDbAdapter;
...
public class DbAdapterTvShowEpisodes extends AbstractDbAdapter {
	...
	public String getLatestEpisodeAirdate(String showId) {
		...
		if (c.moveToFirst())
			s = c.getString(mCache.getColumnIndex(c, com.android.leopardmediahd.db.DbAdapterTvShowEpisodes.KEY_EPISODE_AIRDATE));
		c.close();
		return s;
	}
