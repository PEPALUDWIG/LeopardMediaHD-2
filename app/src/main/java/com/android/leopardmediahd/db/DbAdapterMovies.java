...
public class DbAdapterMovies extends com.android.leopardmediahd.db.AbstractDbAdapter {
    ...
    public void createMovie(String tmdbid, String title, String plot, String imdbid, String rating, String tagline, String release,
        ...
        com.android.leopardmediahd.leopardmediahd.MizuuApplication.getCollectionsAdapter().createCollection(tmdbid, collectionId, collection);
    }
    ...
    private boolean updateMovie(String tmdbid, String title, String plot, String imdbid, String rating, String tagline, String release,
        ...
        return mDatabase.update(DATABASE_TABLE, updateValues, KEY_TMDB_ID + " = ?", new String[]{tmdbid}) > 0 &&
                com.android.leopardmediahd.leopardmediahd.MizuuApplication.getCollectionsAdapter().createCollection(tmdbid, collectionId, collection) > 0;
    }
