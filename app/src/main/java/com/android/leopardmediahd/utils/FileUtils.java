...
public class FileUtils {
	...
	public static File getOldDataFolder() {
		return new File(Environment.getExternalStorageDirectory().toString() + "/data/com.android.leopardmediahd");
	}
    ...
    public static String copyDatabase(Context context) {
        try {
            ...
            com.android.leopardmediahd.utils.FileUtils.copyFile(com.android.leopardmediahd.utils.FileUtils.getDatabaseFile(context), newPath);
