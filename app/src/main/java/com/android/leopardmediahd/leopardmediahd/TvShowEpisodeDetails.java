...
import com.android.leopardmediahd.leopardmediahd.fragments.TvShowEpisodeDetailsFragment;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mViewPager.setOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
			...
			public void onPageSelected(int position) {
                ViewUtils.updateToolbarBackground(com.android.leopardmediahd.leopardmediahd.TvShowEpisodeDetails.this, mToolbar, 0, mEpisodes.get(position).getTitle(), Color.TRANSPARENT);
			}
		});
