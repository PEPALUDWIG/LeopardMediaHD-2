...
import com.android.leopardmediahd.leopardmediahd.fragments.MovieDetailsFragment;
...
public class MovieDetails extends MizActivity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == 4) {
			...
			intent.setClass(getApplicationContext(), com.android.leopardmediahd.leopardmediahd.MovieDetails.class);
