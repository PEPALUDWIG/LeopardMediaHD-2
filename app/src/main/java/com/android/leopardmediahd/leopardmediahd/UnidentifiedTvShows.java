...
public class UnidentifiedTvShows extends com.android.leopardmediahd.base.MizActivity {

	private ArrayList<com.android.leopardmediahd.functions.Filepath> mFilepaths = new ArrayList<com.android.leopardmediahd.functions.Filepath>();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		LocalBroadcastManager.getInstance(this).registerReceiver(mMessageReceiver, new IntentFilter(com.android.leopardmediahd.utils.LocalBroadcastUtils.UPDATE_TV_SHOW_LIBRARY));
	}
	...
	private void identifySelectedFiles() {
		...
		Intent i = new Intent();
		i.setClass(this, com.android.leopardmediahd.leopardmediahd.IdentifyTvShowEpisode.class);
		...
		try {
			if (cursor != null) {
				while (cursor.moveToNext()) {
					mFilepaths.add(new com.android.leopardmediahd.functions.Filepath(cursor.getString(cursor.getColumnIndex(com.android.leopardmediahd.db.DbAdapterTvShowEpisodeMappings.KEY_FILEPATH))));
				}
			}
		...
		case R.id.remove_all:
			...
			.setPositiveButton(getString(android.R.string.yes), new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					...
					com.android.leopardmediahd.utils.TvShowDatabaseUtils.deleteAllUnidentifiedFiles();
