...
public class ActorPhotoFragment extends Fragment {
	...
	public static com.android.leopardmediahd.leopardmediahd.fragments.ActorPhotoFragment newInstance(String url, boolean portraitPhotos) {
		com.android.leopardmediahd.leopardmediahd.fragments.ActorPhotoFragment frag = new com.android.leopardmediahd.leopardmediahd.fragments.ActorPhotoFragment();
		Bundle b = new Bundle();
