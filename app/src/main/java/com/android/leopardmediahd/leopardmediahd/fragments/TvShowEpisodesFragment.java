...
import com.android.leopardmediahd.functions.GridEpisode;
import com.android.leopardmediahd.functions.MizLib;
import com.android.leopardmediahd.functions.TvShowEpisode;
import com.android.leopardmediahd.loader.OnLoadCompletedCallback;
import com.android.leopardmediahd.loader.TvShowEpisodeLoader;
...
import com.android.leopardmediahd.leopardmediahd.TvShowEpisodeDetails;
import com.android.leopardmediahd.utils.LocalBroadcastUtils;
import com.android.leopardmediahd.utils.TvShowDatabaseUtils;
...
import static com.android.leopardmediahd.functions.PreferenceKeys.TVSHOWS_COLLECTION_LAYOUT;
...
public class TvShowEpisodesFragment extends Fragment {
	...
	public static com.android.leopardmediahd.leopardmediahd.fragments.TvShowEpisodesFragment newInstance(String showId, int season) {
		com.android.leopardmediahd.leopardmediahd.fragments.TvShowEpisodesFragment frag = new com.android.leopardmediahd.leopardmediahd.fragments.TvShowEpisodesFragment();
		Bundle b = new Bundle();
	...
	@Subscribe
	public void refreshData(com.android.leopardmediahd.leopardmediahd.TvShowEpisode episode) {
		loadEpisodes();
	}
	...
	public void onViewCreated(View v, Bundle savedInstanceState) {
		...
		mGridView.setMultiChoiceModeListener(new MultiChoiceModeListener() {
			...
			public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
				...
				mBus.post(new com.android.leopardmediahd.leopardmediahd.TvShowEpisode());
	...
	private void syncWatchedStatusWithTrakt(final Set<Integer> checkedEpisodes, final boolean watched) {
		new com.android.leopardmediahd.functions.AsyncTask<Void, Boolean, Boolean>() {
