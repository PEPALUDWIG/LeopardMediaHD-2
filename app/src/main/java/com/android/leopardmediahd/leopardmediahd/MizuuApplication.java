...
import static com.android.leopardmediahd.functions.PreferenceKeys.TV_SHOW_DATA_SOURCE;

public class MizuuApplication extends Application {

	private static com.android.leopardmediahd.db.DbAdapterTvShows sDbTvShow;
	private static com.android.leopardmediahd.db.DbAdapterTvShowEpisodes sDbTvShowEpisode;
	private static com.android.leopardmediahd.db.DbAdapterTvShowEpisodeMappings sDbTvShowEpisodeMappings;
	private static com.android.leopardmediahd.db.DbAdapterSources sDbSources;
	private static com.android.leopardmediahd.db.DbAdapterMovies sDbMovies;
	private static com.android.leopardmediahd.db.DbAdapterMovieMappings sDbMovieMapping;
	private static com.android.leopardmediahd.db.DbAdapterCollections sDbCollections;
	...
	private static com.android.leopardmediahd.functions.FileRequestTransformer mFileRequestTransformer;
	...
	public void onCreate() {
		...
		// Database setup
		sDbMovies = new com.android.leopardmediahd.db.DbAdapterMovies(this);
		sDbMovieMapping = new com.android.leopardmediahd.db.DbAdapterMovieMappings(this);
		sDbTvShowEpisode = new com.android.leopardmediahd.db.DbAdapterTvShowEpisodes(this);
		sDbTvShow = new com.android.leopardmediahd.db.DbAdapterTvShows(this);
		sDbTvShowEpisodeMappings = new com.android.leopardmediahd.db.DbAdapterTvShowEpisodeMappings(this);
		sDbSources = new com.android.leopardmediahd.db.DbAdapterSources(this);
		sDbCollections = new com.android.leopardmediahd.db.DbAdapterCollections(this);
    ...
    private void initializePreferences() {
        ...
        PreferenceManager.setDefaultValues(this, R.xml.credits_prefs, false);
	...
	public static com.android.leopardmediahd.db.DbAdapterTvShows getTvDbAdapter() {
		return sDbTvShow;
	}

	public static com.android.leopardmediahd.db.DbAdapterTvShowEpisodes getTvEpisodeDbAdapter() {
		return sDbTvShowEpisode;
	}
	
	public static com.android.leopardmediahd.db.DbAdapterTvShowEpisodeMappings getTvShowEpisodeMappingsDbAdapter() {
		return sDbTvShowEpisodeMappings;
	}

	public static com.android.leopardmediahd.db.DbAdapterSources getSourcesAdapter() {
		return sDbSources;
	}

	public static com.android.leopardmediahd.db.DbAdapterMovies getMovieAdapter() {
		return sDbMovies;
	}

	public static com.android.leopardmediahd.db.DbAdapterMovieMappings getMovieMappingAdapter() {
		return sDbMovieMapping;
	}
	
	public static com.android.leopardmediahd.db.DbAdapterCollections getCollectionsAdapter() {
	...
	private static com.android.leopardmediahd.functions.FileRequestTransformer getFileRequestTransformer() {
		if (mFileRequestTransformer == null)
			mFileRequestTransformer = new com.android.leopardmediahd.functions.FileRequestTransformer();
	...
	public static Downloader getDownloader(Context context) {
		if (sDownloader == null)
			sDownloader = new com.android.leopardmediahd.functions.OkHttpDownloader(context);
		return sDownloader;
	}
	...
	public static com.android.leopardmediahd.abstractclasses.TvShowApiService getTvShowService(Context context) {
		...
		if (option.equals(context.getString(R.string.ratings_option_0)))
			return com.android.leopardmediahd.apis.thetvdb.TheTVDbService.getInstance(context);
		return com.android.leopardmediahd.apis.tmdb.TMDbTvShowService.getInstance(context);
	}
	
	public static com.android.leopardmediahd.abstractclasses.MovieApiService getMovieService(Context context) {
		return com.android.leopardmediahd.apis.tmdb.TMDbMovieService.getInstance(context);
	}
