...
import com.android.leopardmediahd.leopardmediahd.fragments.TvShowDetailsFragment;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == 0) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                intent.setClass(getApplicationContext(), com.android.leopardmediahd.leopardmediahd.TvShowDetails.class);
