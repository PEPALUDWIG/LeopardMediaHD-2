...
public class TvShow implements Comparable<com.android.leopardmediahd.leopardmediahd.TvShow> {
	...
	@Override
	public int compareTo(com.android.leopardmediahd.leopardmediahd.TvShow another) {
