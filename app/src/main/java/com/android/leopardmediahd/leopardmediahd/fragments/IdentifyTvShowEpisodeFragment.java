...
public class IdentifyTvShowEpisodeFragment extends Fragment {
    ...
    private void updateShow(int id) {
        if (com.android.leopardmediahd.functions.MizLib.isOnline(getActivity())) {
            ...
            Intent identifyService = new Intent(getActivity(), com.android.leopardmediahd.service.IdentifyTvShowEpisodeService.class);
            Bundle b = new Bundle();
    ...
    protected class TvShowSearch extends com.android.leopardmediahd.functions.AsyncTask<Void, Boolean, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                com.android.leopardmediahd.abstractclasses.ApiService<com.android.leopardmediahd.apis.thetvdb.TvShow> service = com.android.leopardmediahd.leopardmediahd.MizuuApplication.getTvShowService(mContext);
                List<com.android.leopardmediahd.apis.thetvdb.TvShow> results = service.search(mQueryText, getSelectedLanguage());
    ...
    public class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.description.setTypeface(com.android.leopardmediahd.utils.TypefaceUtils.getRobotoLightItalic(getActivity()));
