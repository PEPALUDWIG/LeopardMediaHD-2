...
public class ActorBrowserFragment extends Fragment {
	...
	private ArrayList<com.android.leopardmediahd.functions.Actor> mActors = new ArrayList<com.android.leopardmediahd.functions.Actor>();
	...
	public void onViewCreated(View v, Bundle savedInstanceState) {
		...
		mGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                ActivityCompat.startActivity(getActivity(), com.android.leopardmediahd.utils.IntentUtils.getActorIntent(getActivity(), mActors.get(arg2)), options.toBundle());
			}
		});
	...
	protected class GetActorDetails extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			mActors = new ArrayList<com.android.leopardmediahd.functions.Actor>(service.getActors(mMovieId));
