...
public class IdentifyMovieFragment extends Fragment {
    ...
    private com.android.leopardmediahd.identification.MovieStructure mMovieStructure;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMovieStructure = new com.android.leopardmediahd.identification.MovieStructure(mFilepath);

        mPicasso = com.android.leopardmediahd.leopardmediahd.MizuuApplication.getPicasso(getActivity());
        mConfig = com.android.leopardmediahd.leopardmediahd.MizuuApplication.getBitmapConfig();
    ...
    public void onViewCreated(View v, Bundle savedInstanceState) {
        ...
        if (mMovieSearch == null) {
            if (com.android.leopardmediahd.functions.MizLib.isOnline(getActivity())) {
    ...
    private void updateMovie(int id) {
        if (com.android.leopardmediahd.functions.MizLib.isOnline(getActivity())) {
            ...
            Intent identifyService = new Intent(getActivity(), com.android.leopardmediahd.service.IdentifyMovieService.class);
            Bundle b = new Bundle();
            ...
            Intent libraryOverview = new Intent(getActivity().getApplicationContext(), com.android.leopardmediahd.leopardmediahd.Main.class);
    ...
    protected class MovieSearch extends com.android.leopardmediahd.functions.AsyncTask<Void, Boolean, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                List<com.android.leopardmediahd.apis.tmdb.Movie> movieResults = service.search(mQueryText, getSelectedLanguage());
    ...
    public class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.title.setTypeface(com.android.leopardmediahd.utils.TypefaceUtils.getRobotoCondensedRegular(getActivity()));
                holder.release.setTypeface(com.android.leopardmediahd.utils.TypefaceUtils.getRobotoLightItalic(getActivity()));
                holder.rating.setTypeface(com.android.leopardmediahd.utils.TypefaceUtils.getRobotoLightItalic(getActivity()));
                holder.originalTitle.setTypeface(com.android.leopardmediahd.utils.TypefaceUtils.getRobotoLightItalic(getActivity()));
    ...
    public class Result {
        ...
        public Result(String name, String originalTitle, String id, String image, String rating, String release) {
            ...
            mImage = image;
            mRating = rating;
            mRelease = com.android.leopardmediahd.functions.MizLib.getPrettyDate(getActivity(), release);
        }
