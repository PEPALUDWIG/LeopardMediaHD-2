...
public class ActorMoviesFragment extends Fragment {
	...
	private com.android.leopardmediahd.functions.CompleteActor mActor;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        int padding = com.android.leopardmediahd.functions.MizLib.convertDpToPixels(getActivity(), 16);
	...
	public void onViewCreated(View v, Bundle savedInstanceState) {
		...
		mGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                ActivityCompat.startActivity(getActivity(), com.android.leopardmediahd.utils.IntentUtils.getTmdbMovieDetails(mContext, mAdapter.getItem(arg2)), options.toBundle());
			}
		});
	...
	private class ImageAdapter extends BaseAdapter {
        ...
        private ArrayList<com.android.leopardmediahd.functions.WebMovie> mMovies;
		...
		@Override
		public com.android.leopardmediahd.functions.WebMovie getItem(int position) {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			final com.android.leopardmediahd.functions.WebMovie movie = getItem(position);
			
			com.android.leopardmediahd.functions.CoverItem holder;
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.grid_cover_two_line, container, false);
				holder = new com.android.leopardmediahd.functions.CoverItem();
				...
				holder.text.setTypeface(com.android.leopardmediahd.utils.TypefaceUtils.getRobotoMedium(mContext));

				convertView.setTag(holder);
			} else {
				holder = (com.android.leopardmediahd.functions.CoverItem) convertView.getTag();
			}
        ...
        public void notifyDataSetChanged() {
            ...
            // Initialize
            mMovies = new ArrayList<com.android.leopardmediahd.functions.WebMovie>();

            // Go through all movies
            for (com.android.leopardmediahd.functions.WebMovie movie : mActor.getMovies()) {
	...
	private class MovieLoader extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			mActor = com.android.leopardmediahd.apis.tmdb.TMDbMovieService.getInstance(mContext).getCompleteActorDetails(mActorId);

			for (int i = 0; i < mActor.getMovies().size(); i++) {
				String id = mActor.getMovies().get(i).getId();
				mActor.getMovies().get(i).setInLibrary(com.android.leopardmediahd.leopardmediahd.MizuuApplication.getMovieAdapter().movieExists(id));
			}
