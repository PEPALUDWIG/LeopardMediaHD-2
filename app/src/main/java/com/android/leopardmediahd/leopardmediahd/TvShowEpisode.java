...
public class TvShowEpisode implements Comparable<com.android.leopardmediahd.leopardmediahd.TvShowEpisode> {
	...
	@Override
	public int compareTo(com.android.leopardmediahd.leopardmediahd.TvShowEpisode another) {
