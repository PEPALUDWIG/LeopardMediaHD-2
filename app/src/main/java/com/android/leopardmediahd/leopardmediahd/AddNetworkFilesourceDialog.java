...
import com.android.leopardmediahd.leopardmediahd.FileSourceBrowser;
import com.android.leopardmediahd.leopardmediahd.SearchForNetworkShares;
...
import static com.android.leopardmediahd.functions.MizLib.TV_SHOW;
...
public class AddNetworkFilesourceDialog extends Activity {
	...
	public void ok(View v) {	
		if (server.getText().toString().isEmpty()) {
			Toast.makeText(com.android.leopardmediahd.leopardmediahd.AddNetworkFilesourceDialog.this, getString(R.string.enterNetworkAddress), Toast.LENGTH_LONG).show();
			return;
		}
		...
		if (MizLib.isWifiConnected(this)) {
			...
			Toast.makeText(com.android.leopardmediahd.leopardmediahd.AddNetworkFilesourceDialog.this, getString(R.string.noConnection), Toast.LENGTH_LONG).show();
	}
