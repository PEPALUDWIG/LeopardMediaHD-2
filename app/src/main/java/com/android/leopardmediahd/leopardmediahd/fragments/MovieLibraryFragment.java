...
import com.android.leopardmediahd.functions.CoverItem;
import com.android.leopardmediahd.functions.MediumMovie;
import com.android.leopardmediahd.functions.MizLib;
import com.android.leopardmediahd.loader.MovieFilter;
import com.android.leopardmediahd.loader.MovieLoader;
import com.android.leopardmediahd.loader.MovieLibraryType;
import com.android.leopardmediahd.loader.MovieSortType;
import com.android.leopardmediahd.loader.OnLoadCompletedCallback;
import com.android.leopardmediahd.leopardmediahd.MizuuApplication;
import com.android.leopardmediahd.leopardmediahd.MovieCollection;
import com.android.leopardmediahd.leopardmediahd.MovieDetails;
import com.android.leopardmediahd.R;
import com.android.leopardmediahd.leopardmediahd.UnidentifiedMovies;
import com.android.leopardmediahd.leopardmediahd.Update;
...
import static com.android.leopardmediahd.functions.PreferenceKeys.GRID_ITEM_SIZE;
import static com.android.leopardmediahd.functions.PreferenceKeys.IGNORED_TITLE_PREFIXES;
import static com.android.leopardmediahd.functions.PreferenceKeys.SHOW_TITLES_IN_GRID;
...
public class MovieLibraryFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static com.android.leopardmediahd.leopardmediahd.fragments.MovieLibraryFragment newInstance(int type) {
        com.android.leopardmediahd.leopardmediahd.fragments.MovieLibraryFragment frag = new com.android.leopardmediahd.leopardmediahd.fragments.MovieLibraryFragment();
        Bundle b = new Bundle();
        b.putInt("type", type);
        frag.setArguments(b);
        return frag;
