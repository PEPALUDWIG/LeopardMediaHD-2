...
public class NfoMovie {
	...
	private void addToDatabase() {
		...
		com.android.leopardmediahd.functions.Movie temp = new com.android.leopardmediahd.functions.Movie(mContext, mMovie.getTitle(), mMovie.getPlot(), mMovie.getTagline(), mMovie.getId(), mMovie.getImdbId(), mMovie.getRating(),
