...
public class OkHttpDownloader implements Downloader {
	...
	public Response load(Uri uri, boolean localCacheOnly) throws IOException {		
		...
		// Custom data!
		ArrayList<com.android.leopardmediahd.functions.Filepath> filepaths = new ArrayList<com.android.leopardmediahd.functions.Filepath>();
		...
		if (!ignoreNfo) {
			...
			if (imageUri.contains("movie")) {
				...
				if (!TextUtils.isEmpty(id)) {
					...
					filepaths = new ArrayList<com.android.leopardmediahd.functions.Filepath>();
					for (int i = 0; i < strings.size(); i++)
						filepaths.add(new com.android.leopardmediahd.functions.Filepath(strings.get(i)));
					strings.clear();
				}
