...
public class GridEpisode implements Comparable<com.android.leopardmediahd.functions.GridEpisode> {
	...
	@Override
	public int compareTo(com.android.leopardmediahd.functions.GridEpisode another) {
