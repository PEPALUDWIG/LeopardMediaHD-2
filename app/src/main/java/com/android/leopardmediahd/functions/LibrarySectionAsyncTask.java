...
public abstract class LibrarySectionAsyncTask<Params, Progress, Result> {
     ...
     *         {@link com.android.leopardmediahd.functions.LibrarySectionAsyncTask.Status#RUNNING} or {@link com.android.leopardmediahd.functions.LibrarySectionAsyncTask.Status#FINISHED}.
     *
     * @see #executeOnExecutor(Executor, Object[])
     * @see #execute(Runnable)
     */
    public final com.android.leopardmediahd.functions.LibrarySectionAsyncTask<Params, Progress, Result> execute(Params... params) {
	...
	public final com.android.leopardmediahd.functions.LibrarySectionAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
		...
		final com.android.leopardmediahd.functions.LibrarySectionAsyncTask mTask;
        final Data[] mData;

        @SuppressWarnings("rawtypes")
		AsyncTaskResult(com.android.leopardmediahd.functions.LibrarySectionAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
