...
public class MenuItem {
	...
	public static final int HEADER = 0, SEPARATOR = 1000, SEPARATOR_EXTRA_PADDING = 1100, SUB_HEADER = 1500, SECTION = 2000, THIRD_PARTY_APP = 3000, SETTINGS_AREA = 4000, ABOUT_AREA = 5000, UPDATE_AREA = 6000;
