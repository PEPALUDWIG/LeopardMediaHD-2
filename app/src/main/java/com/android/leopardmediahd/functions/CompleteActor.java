...
public class CompleteActor {
	...
	private List<com.android.leopardmediahd.functions.WebMovie> mMovies = new ArrayList<com.android.leopardmediahd.functions.WebMovie>(), mTvShows = new ArrayList<com.android.leopardmediahd.functions.WebMovie>();
	...
	public void setMovies(List<com.android.leopardmediahd.functions.WebMovie> movies) {
		mMovies = movies;

		Collections.sort(mMovies, MizLib.getWebMovieDateComparator());
	}

	public List<com.android.leopardmediahd.functions.WebMovie> getMovies() {
		return mMovies;
	}

	public void setTvShows(List<com.android.leopardmediahd.functions.WebMovie> shows) {
		mTvShows = shows;
