...
import static com.android.leopardmediahd.functions.PreferenceKeys.TVSHOWS_SEASON_ORDER;

public class GridSeason implements Comparable<com.android.leopardmediahd.functions.GridSeason> {
	 ...
	 */
	@Override
	public int compareTo(com.android.leopardmediahd.functions.GridSeason another) {
		if (getSeason() == 0)
			return 1;
