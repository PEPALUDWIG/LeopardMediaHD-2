...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link com.android.leopardmediahd.functions.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *         {@link com.android.leopardmediahd.functions.AsyncTask.Status#RUNNING} or {@link com.android.leopardmediahd.functions.AsyncTask.Status#FINISHED}.
     *
     * @see #executeOnExecutor(Executor, Object[])
     * @see #execute(Runnable)
     */
    public final com.android.leopardmediahd.functions.AsyncTask<Params, Progress, Result> execute(Params... params) {
	...
	public final com.android.leopardmediahd.functions.AsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
		...
		final com.android.leopardmediahd.functions.AsyncTask mTask;
        final Data[] mData;

        @SuppressWarnings("rawtypes")
		AsyncTaskResult(com.android.leopardmediahd.functions.AsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
